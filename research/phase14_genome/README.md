...
**Objective**: To sequence the linguistic structure of the "Rosetta Stone" signals and map the directional influence topology of the market.
...
- **Hypothesis**: These are "War Opcodes" specific to the aggressive algo active on Meme stocks. They are likely aggressive limit-order sweeps not used in index arbitrage.
...
- **Scripts:**
  - `run_genome_project.py` - Genome sequencing script
- **Data:**
  - `data/` - Raw data inputs
- **Output:**
  - `output/influence_edges.csv` - Influence topology data
- **Reports:**
  - `docs/GENOME_REPORT.md` - Full analysis report
  - `docs/MICRO_STRUCTURE_FINDINGS.md` - Detailed microstructure findings
