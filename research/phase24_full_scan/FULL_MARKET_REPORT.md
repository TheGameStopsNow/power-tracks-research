...
## Objective
To find the **"Dark Matter"** of the network: stocks that are not in the Meme Basket but share the same Opcode DNA.
...
![Distribution](charts/market_distribution.png)
...
![Sleepers](charts/sleeper_rank.png)
...
## Artifacts
- [Dragnet Results (CSV)](data/dragnet_results.csv)
- [Sleeper Ranking (PNG)](charts/sleeper_rank.png)
