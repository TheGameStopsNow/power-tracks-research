...
| **Scienter (Intent)** | Tape Smurfing at 499 lots (§4.24.3) proves knowledge of a round-number surveillance threshold — 16 consecutive trades sized at exactly 499, not 498, not 500. The Jelly Roll (§4.24.4) and bilateral IV warping (§4.24.5) demonstrate sophisticated financial engineering incompatible with accidental execution |
...
**Repository**: [github.com/TheGameStopsNow/power-tracks-research](https://github.com/TheGameStopsNow/power-tracks-research/tree/main/research/options_hedging_microstructure/review_package)
